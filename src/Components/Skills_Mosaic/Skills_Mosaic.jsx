        ...
        <div className="skills_mosaic_container">
            ...
            <div className="icons_mosaic">
                <span>
                    ...
                    <img src="src/assets/Icons/icons8-c-programación-96.png"/>
                </div>
                <div className="M_icon selected_cs">
                    <img src="src/assets/Icons/icons8-c-sharp-logo-2-96.png"/>
                </div>
                </span>

                <span>
                    <div className="M_icon selected_cpp">
                    <img src="src/assets/Icons/icons8-logotipo-de-c-plus-plus-96.png"/>
                </div>
                <div className="M_icon selected_git">
                    <img src="src/assets/Icons/icons8-git-96.png"/>
                </div>
                <div className="M_icon selected_css">
                    <img src="src/assets/Icons/icons8-css3-96.png"/>
                </div>
                <div className="M_icon selected_html">
                    <img src="src/assets/Icons/icons8-html-5-96.png"/>
                </div>
                </span>

                <span>
                    <div className="M_icon selected_js">
                    <img src="src/assets/Icons/icons8-javascript-96.png"/>
                </div>
                <div className="M_icon selected_mysql">
                    <img src="src/assets/Icons/icons8-logo-de-mysql-96.png"/>
                </div>
                <div className="M_icon selected_python">
                    <img src="src/assets/Icons/icons8-python-96.png"/>
                </div>
                </span>

                <span>
                    <div className="M_icon selected_react">
                    <img src="src/assets/Icons/icons8-reaccionar-nativo-96.png"/>
                </div>
                <div className="M_icon selected_tailwind">
                    <img src="src/assets/Icons/icons8-viento-de-cola-css-96.png"/>
                </div>
                </span>
            </div>
